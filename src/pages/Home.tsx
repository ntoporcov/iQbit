...
import TorrentTableRow, {TorrentTableHeading,} from "../components/TorrentTableRow"; // only needs to be imported once

const Home = ({expanded}: { expanded?: boolean }) => {
  ...
  return (
    <>
      {expanded && <Box height={60}/>}
      <WindowScroller>
        {({isScrolling, scrollTop, width, height}) => (
          <Flex
            flexDirection={"column"}
            width={"100%"}
            mt={isLarge ? (expanded ? -40 : 24) : 0}
          >
            <PageHeader
              title={"Downloads"}
            ...
            >
              ...
              <Box
                bgColor={bgColor}
                rounded={"lg"}
                position={filterDisclosure.isOpen ? "absolute" : undefined}
                right={0}
              >
                <FilterHeading
            ...
            {expanded && <TorrentTableHeading bgColor={bgColor}/>}
            ...
            <Flex flexDirection={"column"} gap={5}>
              ...
              <List
                ...
                rowHeight={
                  expanded
                    ? (60 * fontSizeContext.scale) / 100
                    : (230 * fontSizeContext.scale) / 100
                }
                width={width}
                height={height}
                scrollTop={scrollTop}
