...
const TPBSearch = (props) => {
  ...
  const [iframe, setIframe] = useState('https://thepiratebay.org/search.php?q=rick')
  const [iframeEl,setIframeEl] = useState({})

  const submitQuery = () => {
    setSearchLoading(true);
    setIframe("https://thepiratebay.org/search.php?q="+searchTerm);
  ...
  return (
    <div>
      ...
      <iframe width={'100%'} height={400} src={iframe.toString()} ref={iframeRef}/>
